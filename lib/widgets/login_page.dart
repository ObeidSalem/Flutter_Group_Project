...
import 'package:group_project_flutter/auth.dart';
...
class LogInWedget extends StatelessWidget {
  const LogInWedget({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.pushAndRemoveUntil(
                      context,
                      MaterialPageRoute(builder: (context) => LogInWedget()),
                      (Route<dynamic> route) => false,
                    );
                  }),
            )
