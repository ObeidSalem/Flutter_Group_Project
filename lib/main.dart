...
class _MyAppState extends State<MyApp> {
  ...
  late String newPost;
  String currentUserName = "Obeid Salem";                     //Tahsin replace this later with user ID
    ...
    return Scaffold(
        ...
        actions: <Widget>[
          Padding(
              ...
              child: GestureDetector(
                onTap: () {},
                child: IconButton(                                //Abdi This is for log out
      ...
      floatingActionButton: Row(
        ...
        children: [
          ...
          SizedBox(width: 10,),
          FloatingActionButton(                                       //Tahsin this to add new post
            onPressed: () async {
